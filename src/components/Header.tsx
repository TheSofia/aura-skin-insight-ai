  ...
  return (
    <header className="relative z-50 border-b border-aurascan-light-grey py-3 px-6 flex justify-between items-center backdrop-blur-xl bg-white/90 shadow-light">
      ...
      <Button 
        ...
        className="text-aurascan-dark-grey hover:bg-aurascan-glass-accent"
      >
      ...
      {isMenuOpen && (
        <div className="absolute top-full right-0 mt-2 w-48 glass-card z-20 animate-fade-in">
          <nav className="py-2">
            <a href="#" className="block px-4 py-2 text-sm text-aurascan-dark-grey hover:bg-aurascan-glass-accent transition-colors">About</a>
            <a href="#" className="block px-4 py-2 text-sm text-aurascan-dark-grey hover:bg-aurascan-glass-accent transition-colors">Privacy Policy</a>
            <a href="#" className="block px-4 py-2 text-sm text-aurascan-dark-grey hover:bg-aurascan-glass-accent transition-colors">Terms of Service</a>
          </nav>
        </div>
      )}
    </header>
